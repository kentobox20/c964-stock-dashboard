...
class SentimentAnalyzer:
    ...
    def predict_sentiment(self, data_dict: Dict) -> Tuple[str, Dict[str, float]]:
        """
    ...
    def analyze_reddit_data(self, reddit_data: List[Dict]) -> List[Dict]:
        ...
        for data_dict in reddit_data:
            sentiment, confidence = self.predict_sentiment(data_dict)
            
            result = data_dict.copy()
            result['predicted_sentiment'] = sentiment
            result['sentiment_confidence'] = confidence
            result['confidence_score'] = confidence[sentiment]
            result['word_score'] = confidence['word_score']
